...
export const Chart: FC<ChartOptions> = ({filteredData, filters}) => {
    ...
    return (
        <Paper variant="outlined" className={paper}>
            <Typography variant="h5" className={header}>{createChartHeader(filters)}</Typography>
            <LineChart width={1300} height={800} data={chartData} style={{margin: "auto"}}
                ...
                >
                    <Label value="Clicks" angle={-90} position="insideLeft" offset={-20}
                ...
                >
                    <Label value="Impressions" angle={90} position="insideRight" offset={-20}
                           style={{fontSize: "1.25rem", fontWeight: 500}}/>
                </YAxis>
